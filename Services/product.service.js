...
exports.getById = async (id) => {
    try {
        ...
        if (isNaN(productId)) return { statusCode: 400, message: `El id '${id}' no es válido. Debe ser un número.`, data: null };
        ...
        if (!product.data || product.data.length === 0) return { statusCode: 404, message: `No se encontró ningún producto con id ${productId}`, data: null };
